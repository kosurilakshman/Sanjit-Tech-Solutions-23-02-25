    ...
    <div className="app_dev">
      <header className="app_dev_hero">
        ...
        >
          <img
            src={app_hero}
            alt="Creative app development hero"
            loading="lazy"
          />
        </div>
        <div className="app_dev_hero_one">
          ...
          >
            Innovative App Development for Mobile &amp; Web for Seamless User
            Experiences
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: -20 }}
        ...
        <section className="why_box" ref={ref}>
          ...
          >
            <p className="app-sub-heading">
              Why Choose Our{" "}
              <span className="app-text-hightlight">
              ...
              <div className="app-box">
                ...
                >
                  <div className="box-content">
                    ...
                    <div className="box-text">
                      <p>
                        User-friendly applications with our custom app
                        development
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="box-content">
                    ...
                    <div className="box-text">
                      <p>
                        User-Friendly Design. Making every interaction intuitive
                        and impactful.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="box-content">
                    ...
                    <div className="box-text">
                      <p>
                        Ongoing maintenance and updates to keep your app running
                        smoothly.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="box-content">
                    ...
                    <div className="box-text">
                      <p>
                        Integrating cutting-edge tech for enhanced performance
                        and scalability.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="box-content">
                    ...
                    <div className="box-text">
                      <p>
                        Secure, efficient, high-performing solutions for a
          ...
          >
            ...
            <div className="professional-box-two">
              ...
              <div className="professional-content">
                ...
                <ul>
                  <li>
                    Fast-loading apps reduce bounce rates and increase
                    retention.
                  </li>
                  <li>
      ...
      >
        <div className="service-contact-img">
          <img
            src={CTA_img}
            alt="Call to action for custom app solutions"
            loading="lazy"
          />
        </div>
        <div className="service-contact-content">
          ...
          <p>
            Today, almost everyone uses apps. Having a custom app for your
            business means you can stay connected with your customers all the
            time. Don’t settle for just any app — get one that’s made just for
            you!
          </p>
